...
const DEFAULT_FORBIDDEN_BY_TOPIC: Array<{ match: string[]; hints: string[] }> = [
  {
    match: ["hospital", "doctor", "clinic", "symptom", "medicine", "krankenhaus", "arzt", "klinik", "sintoma", "sintoma", "medico", "medico", "?��", "?��", "��?"],
    hints: ["bank", "loan", "mortgage", "account", "investment", "kredit", "konto", "banco", "prestamo", "prestamo", "cuenta", "?��", "?γ", "??"]
  },
  {
    match: ["bank", "finance", "loan", "account", "money", "kredit", "konto", "banco", "prestamo", "prestamo", "cuenta", "?��", "?γ", "??"],
    hints: ["hospital", "doctor", "clinic", "symptom", "medicine", "krankenhaus", "arzt", "klinik", "sintoma", "sintoma", "medico", "medico", "?��", "?��", "��?"]
  },
  {
    match: ["interview", "job", "career", "resume", "bewerbung", "vorstellungsgesprach", "vorstellungsgesprach", "entrevista", "trabajo", "��?", "����"],
    hints: ["hospital", "clinic", "symptom", "surgery", "krankenhaus", "klinik", "cirugia", "cirugia", "?��", "�?"]
  },
  {
    match: ["travel", "trip", "airport", "hotel", "reise", "flughafen", "viaje", "aeropuerto", "����", "��?", "����"],
    hints: ["mortgage", "loan", "investment", "surgery", "hypothek", "kredit", "investition", "prestamo", "prestamo", "inversion", "inversion", "?γ", "��?", "�?"]
  }
];
